...
class PasswordResetService:
    ...
    def initiate_password_reset(cls, email):
        ...
        try:
            ...
            if user_exists:
                ...
                cache.set(f"pwd_reset_token:{hashed_token}", token_data, timeout=900)  # 15 minutes
    ...
    def verify_reset_pin(cls, email, pin):
        ...
        if token_data["pin"] != pin:
            ...
            if token_data["attempts"] > 3:
                ...
                cache.delete(f"pwd_reset_user:{user.pk}")
                return False, "Too many failed attempts. Please request a new reset code.", None
    ...
    def reset_password(cls, reset_token, new_password):
        # Get reset session
        hashed_token = cls.hash_token(reset_token, )
        ...
        try:
            ...
            serializer = CustomUserSerializer(user, data={'password': new_password}, partial=True)
